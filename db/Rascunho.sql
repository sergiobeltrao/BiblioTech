...
('O Pequeno Príncipe', '978-85-7657-319-5', 1943, 96, '4 - Literatura Infantil e Juvenil', '18 - Contos de Fadas', 'Francês - França', 'Gallimard', 'Uma história encantadora sobre amizade e valores essenciais da vida.'),
...
('O Código Da Vinci', '978-85-7542-876-9', 2003, 448, '1 - Ficção', '2 - Mistério', 'Português - Brasil', 'Editora Arqueiro', 'Uma trama envolvente de conspirações e mistérios ligados à Igreja Católica.'),
('A Arte da Guerra', '978-85-336-1881-9', 0001, 112, '2 - Não Ficção', '9 - História', 'Português - Brasil', 'L&PM Pocket', 'Um tratado militar atribuído a Sun Tzu sobre estratégias de guerra.'),
('O Senhor dos Anéis: A Sociedade do Anel', '978-85-7827-122-3', 1954, 576, '1 - Ficção', '4 - Fantasia', 'Inglês - Reino Unido', 'Martins Fontes', 'A primeira parte da trilogia épica de J.R.R. Tolkien.');
