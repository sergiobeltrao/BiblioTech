...
-- TABELA DE CONSULTA COM OS DADOS DISPONÍVEIS QUE SERÃO USADOS PARA ALIMENTAR O BANCO.
-- DADOS QUE ESTARÃO DISPONÍVEIS NO BIBLIOTECH.
...
SELECT USE_ID FROM USUARIO WHERE USE_NICK = 'admin';

SELECT ID_LIVRO, LIV_NOME_LIVRO, LIV_ISBN, LIV_ANO, LIV_PAGINA, LIV_CATEGORIA, LIV_SUBCATEGORIA, LIV_IDIOMA, LIV_EDITORA FROM LIVRO;
...
SELECT
    ...
    L.LIV_EDITORA
FROM LIVRO L
JOIN AUTOR A ON L.ID_LIVRO = A.ID_AUTOR;
