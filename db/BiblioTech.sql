...
INSERT INTO LIVRO VALUES(
	NULL, 'O Segredo das Estrelas', '978-1234567890', 1980, 320, 10,  '1 - Ficção', '180.20', '40 - Programação', 'Portugues'),
    (NULL, 'O Alquimista', '978-8584390670', 1988, 208, 20,  '1 - Ficção', '40.15', '4 - Fantasia', 'Português - Brasil');
...
CREATE TABLE LIVRO_EDITORA ( 
	LIVRO_CHAVE INT NOT NULL, FOREIGN KEY (LIVRO_CHAVE) REFERENCES LIVRO (ID_LIVRO),
    LIVRO_EDITORA INT NOT NULL, FOREIGN KEY (LIVRO_EDITORA) REFERENCES EDITORA (ID_EDITORA),
    PRIMARY KEY (LIVRO_CHAVE, LIVRO_EDITORA)
);
...
CREATE TABLE EDITORA_AUTOR ( 
	...
	ENDERECO_AUTOR INT NOT NULL, FOREIGN KEY (ENDERECO_AUTOR) REFERENCES AUTOR (ID_AUTOR),
    PRIMARY KEY (ENDERECO_CHAVE, ENDERECO_AUTOR)
);

CREATE TABLE EDITORA_TELEFONE ( 
    ENDERECO_CHAVE INT NOT NULL, FOREIGN KEY (ENDERECO_CHAVE) REFERENCES ENDERECO (END_ID),
    EDITORA_TELEFONE INT NOT NULL, FOREIGN KEY (EDITORA_TELEFONE) REFERENCES TELEFONE (TEL_ID),
    PRIMARY KEY (ENDERECO_CHAVE, EDITORA_TELEFONE)
);

CREATE TABLE EDITORA_ENDERECO ( 
	ENDERECO_CHAVE INT NOT NULL, FOREIGN KEY (ENDERECO_CHAVE) REFERENCES ENDERECO (END_ID),
    ENDERECO_USER INT NOT NULL, FOREIGN KEY (ENDERECO_USER) REFERENCES USUARIO (USE_ID),
    PRIMARY KEY (ENDERECO_CHAVE, ENDERECO_USER)
);
...
/*TABELA DE CHAVES ESTRANGEIRAS ENDEREÇO */
CREATE TABLE ENDERECO_AUTOR ( 
    ENDERECO_CHAVE INT NOT NULL, FOREIGN KEY (ENDERECO_CHAVE) REFERENCES ENDERECO (END_ID),
    ENDERECO_AUTOR INT NOT NULL, FOREIGN KEY (ENDERECO_AUTOR) REFERENCES AUTOR (ID_AUTOR),
    PRIMARY KEY (ENDERECO_AUTOR, ENDERECO_CHAVE)
);
...
INSERT INTO ENDERECO_USUARIO VALUES (3, 1), (1, 2), (2, 3);
...
/*ESTE COMANDO DA UM PRINT DAS INFORMAÇÕES LISTAS DE TODOS OS USUARIOS*/
