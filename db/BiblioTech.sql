...
-- O INT usado no AVA_ID_USUARIO é i ID do usuario da tabela usuario, o mesmo se aplica ao AVA_FK_LIVRO
 ...
 VALUES (45, 1, '9', 7.5, 'Este comentario é para testar a tela de avaliação de livros!');
